				...
				<div class="search-area">
					<div class="search-item">
						<select name="searchType" id="searchType">
							...
							<option value="B"
								<c:out value="${pc.fc.searchType == 'B' ? 'selected':'' }"/>>일자</option>
							<option value="C"
								<c:out value="${pc.fc.searchType == 'C' ? 'selected':'' }"/>>상품명</option>
							<option value="D"
								<c:out value="${pc.fc.searchType == 'D' ? 'selected':'' }"/>>메인요리</option>
							<option value="E"
								<c:out value="${pc.fc.searchType == 'E' ? 'selected':'' }"/>>밥</option>
							<option value="F"
								<c:out value="${pc.fc.searchType == 'F' ? 'selected':'' }"/>>반찬1</option>
							<option value="G"
								<c:out value="${pc.fc.searchType == 'G' ? 'selected':'' }"/>>반찬2</option>
							<option value="H"
								<c:out value="${pc.fc.searchType == 'H' ? 'selected':'' }"/>>반찬3</option>
							<option value="I"
								<c:out value="${pc.fc.searchType == 'I' ? 'selected':'' }"/>>김치</option>
							<option value="J"
								<c:out value="${pc.fc.searchType == 'J' ? 'selected':'' }"/>>샐러드</option>
							<option value="K"
								<c:out value="${pc.fc.searchType == 'K' ? 'selected':'' }"/>>국</option>
						</select>
					</div>
					<div class="search-item">
