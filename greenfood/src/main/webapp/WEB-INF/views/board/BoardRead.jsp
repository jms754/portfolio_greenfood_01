...
function init() {
	...
	<c:if test="${boardVO.boardCategoryVO.cname == 'Q&A' && sessionScope.member.admin == 1 }">
	//답글
									...
									<div class="hit">
										<span class="board-id"><strong>조회수</strong>
											${boardVO.bhit }</span>
									                        ...
									                        <c:if test="${boardVO.menu != null }">
                        <div class="board-view-info">
                              <strong class="col-1">리뷰 메뉴</strong>
                              <span class="board-id">${boardVO.menu }</span>
                           </div>
                           </c:if>
								<!-- 첨부목록 -->
