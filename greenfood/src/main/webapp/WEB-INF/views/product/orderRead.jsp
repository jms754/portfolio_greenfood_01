...
<div class="orderRead">
  <form id="orderReadForm" method="post"  >
        ...
        <tr class="form-group">
             ...
             <td class="row">   
                 <div class="addressApi">
                  <div><input type="text" name=faddress id="sample6_postcode" placeholder="우편번호"  value="${info.address1 }" readonly="readonly" /></div>
                 <div><input type="text" name="faddress" id="sample6_address" placeholder="주소" value="${info.address2 }" readonly="readonly" /></div>
                 <div><input type="text" name="faddress" id="sample6_detailAddress" placeholder="상세주소" value="${info.address3 }" readonly="readonly" />
    ...
    <table class="pay_tbl">
       ...
       <c:set var="name" value="무통장입금" />
       <c:if test="${name eq payment}" >
        <tr> 
